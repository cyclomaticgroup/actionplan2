...
class qsot_core_hacks
{
    ...
    public static function view_completed_email($order)
    {
        ...
        <html>
    <head>
        <title><?php echo $email->get_subject() . ' - ';
    ...
    private static function getFastPrep($wpdb, $item)
    {
        return $wpdb->prepare("SELECT ID FROM {$wpdb->posts} WHERE post_title = %s AND post_type = 'shop_coupon' AND post_status = 'publish' LIMIT 1;", $item['name']);
    }
    ...
    public function woocommerce_order_totals_meta_box($post)
    {
        ...
        <div class="totals_group">
            <h4>
                <span class="discount_total_display inline_total"></span><?php _e('Discounts', 'opentickets-community-edition'); ?>
            </h4>
            <ul class="totals">

                <li class="left">
                    <label><?php _e('Cart Discount:', 'opentickets-community-edition'); ?>&nbsp;<a class="tips"
                                                                                                   data-tip="<?php _e('Discounts before tax - calculated by comparing subtotals to totals.', 'opentickets-community-edition'); ?>"
                                                                                                   href="#">[?]</a></label>
                    <input type="number" step="any" min="0" id="_cart_discount" name="_cart_discount" placeholder="0.00"
                           value="<?php
                ...
                <li class="right">
                    <label><?php _e('Order Discount:', 'opentickets-community-edition'); ?>&nbsp;<a class="tips"
                                                                                                    data-tip="<?php _e('Discounts after tax - user defined.', 'opentickets-community-edition'); ?>"
                                                                                                    href="#">[?]</a></label>
                    <input type="number" step="any" min="0" id="_order_discount" name="_order_discount"
        ...
        <div class="totals_group">
            ...
            <ul class="totals">
                ...
                <li class="wide">
                    ...
                    <input type="text" id="_shipping_method_title" name="_shipping_method_title"
                           placeholder="<?php _e('The shipping title the customer sees', 'opentickets-community-edition'); ?>"
                           value="<?php
                ...
                <li class="left">
                    ...
                    <input type="number" step="any" min="0" id="_order_shipping" name="_order_shipping"
                           placeholder="0.00 <?php _e('(ex. tax)', 'opentickets-community-edition'); ?>" value="<?php
    ...
    <?php endif; ?>
        ...
        <div class="totals_group tax_rows_group">
            ...
            <h4><a href="#" class="add_tax_row"><?php _e('+ Add tax row', 'opentickets-community-edition'); ?> <span
                            class="tips"
                            data-tip="<?php _e('These rows contain taxes for this order. This allows you to display multiple or compound taxes rather than a single total.', 'opentickets-community-edition'); ?>">[?]</span></a></a>
            </h4>
            <div class="clear"></div>
        </div>
        <div class="totals_group">
            <h4>
                <span class="tax_total_display inline_total"></span><?php _e('Tax Totals', 'opentickets-community-edition'); ?>
            </h4>
            <ul class="totals">

                <li class="left">
                    <label><?php _e('Sales Tax:', 'opentickets-community-edition'); ?>&nbsp;<a class="tips"
                                                                                               data-tip="<?php _e('Total tax for line items + fees.', 'opentickets-community-edition'); ?>"
                                                                                               href="#">[?]</a></label>
                    <input type="number" step="any" min="0" id="_order_tax" name="_order_tax" placeholder="0.00"
                           value="<?php
                ...
                <li class="right">
                    ...
                    <input type="number" step="any" min="0" id="_order_shipping_tax" name="_order_shipping_tax"
                           placeholder="0.00" value="<?php
    ...
    <?php endif; ?>
        ...
        <div class="totals_group">
            ...
            <ul class="totals">
                ...
                <li class="left">
                    ...
                    <input type="number" step="any" min="0" id="_order_total" name="_order_total" placeholder="0.00"
                           value="<?php
        ...
        <p class="buttons">
            <?php if (get_option('woocommerce_calc_taxes') == 'yes') : ?>
                <button type="button"
                        class="button calc_line_taxes"><?php _e('Calc taxes', 'opentickets-community-edition'); ?></button>
            <?php endif; ?>
            <button type="button"
                    class="button calc_totals button-primary"><?php _e('Calc totals', 'opentickets-community-edition'); ?></button>
        </p>
        <?php
    }
